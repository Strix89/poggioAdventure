...
public class Level1State extends GameState {
    ...
    public void enter(GameDescription gameDescription, OutputHandler output, String playerName) {
        ...
        AdvNPC donMatteo = new AdvNPC(Utils.NPC_GENERIC_ID, "NPC", "Un personaggio non giocante generico.");
        ...
        AdvObject post_it = new AdvObject(Utils.OBJ_POST_IT_ID, "post-it", "Un post-it con delle istruzioni.");
    ...
    @Override
    public void getLevelDescription(OutputHandler output) {
        output.writeln("\nIMAGE:" + ResourceLoader.IMG_PATH.resolve("DirettoreIngresso.png").toString() + "\n");
    }
}